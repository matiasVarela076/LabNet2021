...
namespace Ejercicio3Exceptions
{
    ...
    {
        public static void divisionPorCero(this int num) //Punto 1 (con extension method)
        {
            try
            {
                int resultado = num / 0;
        ...
        public static void division(this int divisor, int dividendo) //Punto 2 (Con extension method)
        {
            try
            {
